                            ...
                            @endphp
                                @if($posts->isNotEmpty()) 
                                    ...
                                    <div class="d-flex align-items-center mb-2" style="margin-left: 2%;margin-right: 2%;">
                                        <a class="category-click"  data-id="{{ $category->id }}" data-url="{{ route('particularcat', $category->slug) }}" href="{{ route('particularcat', $category->slug) }}">{{ $category->title }}</a>
                    ...
                    <div class="news-categories mb-5 mt-2 d-none d-md-block">
                        ...
                        <ul class="list-unstyled">
                            @if($newscategories->isNotEmpty())
                                ...
                                href="{{ route('particularcat', $category->slug) }}" data-url="{{ route('particularcat', $category->slug) }}">{{ $category->title }} ({{ $category->posts_count ?? 0 }})</a></li>
                                @endforeach
                            @else
                                <li>
