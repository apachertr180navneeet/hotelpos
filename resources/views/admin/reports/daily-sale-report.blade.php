               ...
               <form class="card" method="POST" id="profirReportForm">
                  ...
                  <div class="card-header pb-0">
                     <div class="row">
                        <div class="col-6 col-sm-6">
                           <h4 class="card-title mb-0">{{$controller::message("Daily Sale Report")}}</h4>
                        </div>
                        <div class="col-6 col-sm-6">
                  ...
                  <div class="card-body">
                     <div class="row">
                        ...
                        <div class="col-sm-6 col-xl-6col-lg-6">
                           <div class="card o-hidden">
                              <div class="card-body">
                                 <div class="media static-widget">
                                    <div class="media-body">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4">
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                 <div class="btn btn-success export-data-btn" style="width:100%; padding:10px;">
                                    {{$controller::message("Export to Excel")}}
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="urahyuwwmn">
                              <table class="table table-bordered">
                                 <tr>
                                    ...
                                    <th width="10%">{{$controller::message("Profit")}}</th>
                                 </tr>
                                 <tbody>
                                    @if(!empty($products))
                                    @php($i=1)
                                    ...
                                    <tr>
                                       ...
                                       <td width="10%">{{$product['heading']}}</td>
                                       ...
                                       <td width="10%">
                                          {{$product['discount']}}
                                          @php($totalDiscount[] = $product['discountValue'])
                                       </td>
                                       <td width="10%">{{$totaTaxAmount[] = $product['tax']}}</td>
                                       <td width="10%">{{$totalCostAmount[] = $product['cost']}}</td>
                                    ...
                                    <tr>
                                       ...
                                       <td class="hvyqqldbgk"></td>
                                       <td class="ygfqstaeix">{{array_sum($totalQuantity)}}</td>
                                       <td class="exfhhxsfce">{{array_sum($totalDiscount )}}</td>
                                       <td class="rgbqrupaah">{{array_sum($totaTaxAmount)}}</td>
                                       <td class="xajmglbxdu">{{array_sum($totalCostAmount)}}</td>
                                       <td class="gedwuspqxa">{{array_sum($totalSaleAmount)}}</td>
...
@php($profitReport = "dailySaleReport")
@endsection