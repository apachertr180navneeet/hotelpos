            ...
            <form class="card" method="POST" id="manualForm">
               ...
               <div class="card-body">
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        <h3>{{$field['fieldHeadingBefore']}}</h3>
                     </div>
                     @endif   
                     ...
                     <?php }else{ ?>
                     <div class="col-md-<?php echo $field['fieldColumn'];?>">
                        <div class="mb-3">
                           <?php
                           ...
                           <label class="form-label"><?php echo $field['fieldHeading'];?><?php echo ($required==1)?'<span class="required">*</span>':'';?></label>
                           <?php if(in_array($field['fieldType'],$filedTypeText)){?>
                           <input class="form-control <?php echo ($required==1)?'requiredField':'';?> <?php echo $field['fieldClass'];?>" id="<?php echo $field['fieldId'];?>" type="<?php echo $field['fieldType'];?>" name="<?php echo $field['fieldName'];?><?php echo ($field['fieldAttribute']=='multiple')?'[]':'';?>" placeholder="<?php echo $field['fieldHeading'];?>" value="<?php echo ($field['fieldType']!="password" AND $field['fieldType']!="file")?$field['fieldDefaultValue']:'';?>" <?php echo ($required==1)?'required':'';?> <?php echo ($readonly==1)?'readonly':'';?> <?php echo $field['fieldAttribute'];?>>
                           ...
                           <div class="relatedImages">
                              ...
                              @if($extension[array_key_last($extension)]=="jpg" || $extension[array_key_last($extension)]=="jpeg" || $extension[array_key_last($extension)]=="png" || $extension[array_key_last($extension)]=="bmp" || $extension[array_key_last($extension)]=="jiff" || $extension[array_key_last($extension)]=="webp")
                           ...
                           <select class="form-control select2 <?php echo ($required==1)?'requiredField':'';?> <?php echo $field['fieldClass'];?>" id="<?php echo $field['fieldId'];?>" name="<?php echo $field['fieldName'];?><?php echo ($field['fieldAttribute']=='multiple')?'[]':'';?>" <?php echo ($required==1)?'required':'';?> <?php echo ($readonly==1)?'readonly':'';?> <?php echo $field['fieldAttribute'];?>>
                              <?php if($field['fieldAdditionalAttribute']!='removePleaseSelect' AND $field['fieldSelectBoxText']==''){?>
                              ...
                              <?php foreach($values as $value){ ?>
                              @php($text = "")
                              @php($explods = explode(",",$field['fieldSelectMainColumn']))
                              @foreach($explods as $explode)
                                 @php($text .= $value[$explode]." - ");
                              @endforeach
                              @php($text = rtrim($text, " - ")) 
                              <option <?php echo (in_array($value[$field['fieldSelectIdColumn']],$array))?'selected':'';?> <?php echo ($field['fieldDefaultValue']==$value[$field['fieldSelectIdColumn']])?'selected':'';?> value="<?php echo $value[$field['fieldSelectIdColumn']];?>"><?php echo $text;?></option>
                              <?php } ?>
                              <?php } ?>
                              <?php } ?>
                              <?php } ?>
               ...
               <div class="snzsdfsqzp" style="display: block;padding: 0px 0px 0px 30px;">
                        ...
                        <div class="relatedImages">
                           ...
                           <div class="relatedImagesDiv">
                              <div class="imageDiv">
                                 ...
                                 <input type="hidden" value="<?php echo $field['addMoreFieldDefaultValue'];?>" name="extra[<?php echo $field['addMoreFieldName'];?>_hidden][]">
                              </div>
               ...
               <div class="row nljqvqzidj" style="padding: 30px;">
                  ...
                  <?php } ?>
                  <?php if(!empty($addMore)){?>
                  <div class="snzsdfsqzp" style="display: block;">
