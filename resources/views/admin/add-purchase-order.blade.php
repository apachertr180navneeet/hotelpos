               ...
               <form class="card" method="POST" id="purchaseForm">
                  ...
                  <div class="card-header pb-0">
                     <div class="row">
                        <div class="col-6 col-sm-6">
                           <h4 class="card-title mb-0">{{$controller::message("Add Purchase Order")}}</h4>
                        </div>
                        <div class="col-6 col-sm-6">
                  ...
                  <div class="card-body">
                     <div class="row">
                        ...
                        <div class="col-md-3">
                           <div class="mb-3">
                              <label class="form-label">{{$controller::message("Purchase Order Heading")}}<span class="required">*</span></label>
                           ...
                           <div class="mb-3">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    <input type="text" name="cost" class="form-control sjhnfqntvl isFloat cdyedrdrhq" placeholder="{{$controller::message("Cost")}}">
                           ...
                           <div class="urahyuwwmn">
                              ...
                              <table class="table table-bordered">
                                 ...
                                 <tbody class="ywnxwtxvem">
                                    ...
                                    @php($products = array_reverse(Session::get("purchaseOrderCart")))
