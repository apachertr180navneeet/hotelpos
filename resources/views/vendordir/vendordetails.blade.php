    ...
    <div class="auto-container">
        <div class="title-outer">
            ...
            <ul class="page-breadcrumb">
                <li><a href="{{ route('vendordirectory') }}">Vendors</a></li>
                <li><a href="{{ route('vendorDetails', $vendor->id) }}">{{ $vendor->company_name }}</a></li>
            </ul>  --}}

            <h5 class="page-breadcrumb text-left" style="font-size: 20px;font-weight: bolder; margin-left:7%;">
                ...
                @foreach ($products as $pkey => $product)                
                    <div class="product-card mb-4">
                        <div class="row g-3 align-items-center">
                            <!-- Product Image -->
                            @if(!empty($product->logo)&& file_exists(public_path('uploads/vendoragency_product/' . $product->logo)))
            ...
            <ul class="vendor-list">
                @foreach ($blogs as $bkey => $blog)                
                    <div class="product-card mb-4">
                        <div class="row g-3 align-items-center">
                            <!-- Product Image -->
                            @if(!empty($blog->logo) && file_exists(public_path('uploads/vendoragency_blog/' . $blog->logo)))
                            <div class="col-md-3 text-center">                                
