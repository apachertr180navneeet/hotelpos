...
@section('content')
    ...
    <section class="page-title">
        <div class="auto-container">
            ...
            <h5 class="page-breadcrumb text-left" style="font-size: 20px;font-weight: bolder; margin-left:6.5%"><a href="{{ route('vendordirectory') }}">Travel Nursing Industry Vendor Directory</a></h5>
        </div>
    </section>
    ...
    <div class="container">
        <div class="content-box">
            <div class="content-title mt-3">
                <div class="row">
                    <form class="d-flex w-100 find-service-div" action="{{ route('vendordirectory.search') }}" method="GET">
                        <div class="col-md-9">
                            <div class="form-group search-form-type">
                                ...
                                <select name="filter" class="form-control me-2">
                                    ...
                                    <option value="category" {{ request('filter') == 'category' ? 'selected' : '' }}>By Category</option>
                                ...
                                <li class="list mt-2">
                                    ...
                                    @php
                                        ...
                                        $subcategories = App\Models\VendorSubCategory::select('vendor_subcategories.id', 'vendor_subcategories.title', 'vendor_subcategories.slug')
                                            ...
                                            ->orderBy('vendor_subcategories.title', 'asc')
