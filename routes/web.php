...
//Useruser Community
use App\Http\Controllers\UserCommunity\UserCommunitySignupController;
use App\Http\Controllers\UserCommunity\UserCommunityLoginController;
use App\Http\Controllers\UserCommunity\UserCommunityLogoutController;
use App\Http\Controllers\UserCommunity\UserCommunityDashboardController;
use App\Http\Controllers\UserCommunity\UserCommunityProfileController;
use App\Http\Controllers\UserCommunity\UserCommunityCategoryController;
use App\Http\Controllers\UserCommunity\UserCommunityTopicController;
...
Route::get('agencyreviews', [HomeController::class, 'resources'])->name('resources');

Route::get('agencyreviews/get-resource-feedback', [HomeController::class, 'getResourceFeedback'])->name('resource.feedback');
...
Route::get('vendordirectory', [VendorController::class, 'vendorcategory'])->name('vendordirectory');

Route::get('vendordirectory-search', [VendorController::class, 'vendorcategorySearch'])->name('vendordirectory.search');

Route::get('vendordirectory/{vendor_category_slug}/{vendor_subcategory_slug}', [VendorController::class, 'vendorList'])->name('vendorList');

Route::get('vendordirectory/{vendor_category_slug}', [VendorController::class, 'vendorSubList'])->name('vendorSubList');
...
Route::post('vendordirectory/contact-mail-send', [VendorController::class, 'contactMailSend'])->name('vendordirectory.mail.send');

Route::post('vendordirectory/store-company-details', [VendorController::class, 'storeCompanyDetails'])->name('vendordirectory.submit-company');
...
Route::get('news/{slug}', [HomeController::class, 'particularcat'])->name('particularcat');
...
Route::prefix('community')->name('community.auth.')->group(function () {

    Route::get('/signup', [UserCommunitySignupController::class, 'index'])->name('signup');

    Route::post('/signup', [UserCommunitySignupController::class, 'signup'])->name('signup.submit');

    Route::get("/login", [UserCommunityLoginController::class, "index"])->name("login");

    Route::post("/login", [UserCommunityLoginController::class, "login"])->name("submit");

    Route::post("/logout", [UserCommunityLogoutController::class, "index"])->name("logout");

    Route::name("dashboard.")->prefix("/dashboard")->middleware(["auth"])->group(function() {

        // dashboard home
        Route::get("/admin", [UserCommunityDashboardController::class, "index"])->name("home");
    });

    // Community Categories

    Route::prefix("/communitycategories")->name("communitycategories.")->controller(UserCommunityCategoryController::class)->group(function () {
    ...
    Route::resource("/communitycategories", UserCommunityCategoryController::class);


    // Community Topic

    Route::prefix("/topic")->name("topic.")->controller(UserCommunityTopicController::class)->group(function () {
    ...
    Route::resource("/topic", UserCommunityTopicController::class);
    ...
    Route::prefix("/settings")->name("settings.")->group(function() {
        ...
        Route::get("/profile", [UserCommunityProfileController::class, "index"])->withoutMiddleware(["admin"])->name("profile");

        Route::post("/profile", [UserCommunityProfileController::class, "update"])->withoutMiddleware(["admin"])->name("profile.update");

        // password change

        Route::get("/change-password", [UserCommunityProfileController::class, "password"])->withoutMiddleware(["admin"])->name("password");

        Route::post("/change-password", [UserCommunityProfileController::class, "passwordUpdate"])->withoutMiddleware(["admin"])->name("password.update");
